...
function generateProject(project) {
    ...
    projectBox.innerHTML = `
                <a href="javascript:void(0)" id="project-${id}" p-desc="${description}" class="project-box fancybox zoom-btn" data-fancybox="p-${id}">
...
function generateRoom(room) {
    ...
    roomBox.innerHTML = `
            <a href="javascript:void(0)" class="room-box fancybox zoom-btn" data-fancybox="${id}">
            <div class="room-img">
                <img src="${thumbnail}" alt="${name}" loading="lazy">
            </div>
